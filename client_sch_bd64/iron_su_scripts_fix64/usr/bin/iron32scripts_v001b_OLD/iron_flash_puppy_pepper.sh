...
AAA="/usr/share/iron_flash/chrome-wrapper $@ --disable-translate --user-data-dir=/home/puppy/iron_flash_puppy_user_data_dir --disk-cache-dir=/home/puppy/.cache/iron_flash  --ppapi-flash-path=/usr/share/iron_flash/extensions/libpepflashplayer.so --ppapi-flash-version=31.0.0.108 --always-authorize-plugins "
sudo -u puppy $AAA
